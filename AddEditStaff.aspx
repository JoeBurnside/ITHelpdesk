<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddEditStaff.aspx.vb" Inherits="AddEditStaff" %>
...
<body>
    ...
    <asp:Label ID="lblForename" runat="server" 
        style="z-index: 1; left: 73px; top: 73px; position: absolute; right: 818px; height: 19px;" 
    ...
    <asp:Label ID="lblEmail" runat="server" 
        style="z-index: 1; left: 94px; top: 144px; position: absolute" 
    ...
    <asp:TextBox ID="txtSurname" runat="server" 
        style="z-index: 1; top: 107px; position: absolute; left: 173px" 
        MaxLength="50"></asp:TextBox>
    <asp:TextBox ID="txtConfirm" runat="server" 
        style="z-index: 1; left: 173px; top: 249px; position: absolute" 
        TextMode="Password" MaxLength="50"></asp:TextBox>
    <asp:TextBox ID="txtEmail" runat="server" 
        style="z-index: 1; left: 173px; top: 142px; position: absolute" 
        MaxLength="50"></asp:TextBox>
    <asp:TextBox ID="txtForename" runat="server" 
        style="z-index: 1; left: 173px; top: 72px; position: absolute" 
        MaxLength="50"></asp:TextBox>
    <asp:TextBox ID="txtPhoneNo" runat="server" 
        style="z-index: 1; left: 173px; top: 177px; position: absolute" 
        MaxLength="50"></asp:TextBox>
