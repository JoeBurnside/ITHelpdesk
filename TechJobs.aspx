<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TechJobs.aspx.vb" Inherits="AvailableJobs" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnBack" runat="server" 
            style="z-index: 1; left: 436px; top: 238px; position: absolute" Text="Back" />
